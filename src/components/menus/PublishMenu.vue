<template>
  <div class="side-bar__panel side-bar__panel--menu">
    ...
    <div v-else>
      ...
      <hr>
      <div
        v-for="token in bloggerTokens"
        :key="'blogger-' + token.sub"
      >
      ...
      <div
        v-for="token in googleDriveTokens"
        :key="token.sub"
      >
      ...
      <div
        v-for="token in wordpressTokens"
        :key="token.sub"
      >
